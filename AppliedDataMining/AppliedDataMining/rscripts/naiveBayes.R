#Naive Bayes classifier example in R
#INFO I590 Online Applied Data Mining
#Instructor: Hasan Kurban

#1. Naive Bayes via "caret package"
library("caret")
head(iris)
# In this part, we first train a naive bayes classifier, and then use it to classify
...
#confusion matrix
table(predict(model2,ts[,1:4])$class,ts[,5])
# plot the features 
plot(model2)