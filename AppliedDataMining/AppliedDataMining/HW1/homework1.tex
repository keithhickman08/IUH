...
\newcommand{\hmwkDueDate}{Monday,\ August\ 31,\ 2017\ 10:00P} % Due date
...
Listing \ref{s1} shows R script that graphs a function $f(x) = (1 + 1/x)^x$ at points $x=1,6,11,\ldots,200$.  The graph is saved to \texttt{plot.png}.
