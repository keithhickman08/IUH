...
\newcommand{\hmwkDueDate}{Wednesday,\ September\ 6,\ 2017\ 5:00P} % Due date
...
Listing \ref{s2} shows R script that graphs a function $f(x) = (1 + 1/x)^x$ at points $x=1,6,11,\ldots,200$.  The graph is saved to \texttt{plot2.png}.

\rscript{s2}{Sample R Script With Highlighting}
...
\begin{homeworkProblem}
This is the graph from Problem 1. 

\problemAnswer{
\begin{center}
\includegraphics[width=0.75\columnwidth]{plot2.png} % Example image
\end{center}
}
\end{homeworkProblem}
